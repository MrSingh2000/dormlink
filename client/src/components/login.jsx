...
const LoginForm = () => {
  return (
    <div className="flex flex-col md:flex-row justify-center items-center h-screen bg-[#b3dee584] ">
        <div className="flex flex-col md:flex-row justify-center items-center h-1/2 shadow-md bg-[#fae6b1] rounded px-12 pt-6 pb-8 mb-4 ">
      <div className="w-1/3 md:w-1/2">
        <img src={loginImage} alt="Login" style className=" visible" />
      </div>
